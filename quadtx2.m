function [Q,fcount] = quadtx2(F,a,b,tol,varargin)
% **Modified from original 'quadtx'. Now, the error must be less than tol(h/(b-a)).**
%
...
if abs(Q2 - Q1) <= tol*(h/3) % modification from original
   Q  = Q2 + (Q2 - Q1)/15;
   fcount = 2;
else
