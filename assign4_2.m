...
% form 'Ax=b' using the Gauss-Seidel iterative method. This version records
% results from a variation of matrix ranks and tolerances.

N = [16, 32, 64]; % rank of matrix A
tol = [1.e-3, 1.e-5, 1.e-7, 1.e-9]; % range of tolerances to test against
