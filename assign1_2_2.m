...
% Plots the error when using Chebyshev polynomial interpolation of the hubbard function for polynomials
...
for k=1:5
    ...
    for m=1:n(k)
        ...
        xEqual(m) = xEqual(m)*(0.5)+0.5; % move the Chebyshev interval from [-1,1] to [0,1]
    end
    yEqual = hubbard(xEqual, t);
